...
<div id="exampleModalDatos" class="modal fade " role="dialog">
...
// ------  Codigo solicitud datos usuarios_tecnicos para editar -------
    ...
    $query = "SELECT * FROM usuarios_clientes INNER JOIN comunas ON usuarios_clientes.comuna = comunas.id_comuna WHERE usuarios_clientes.rut = '$var_sesion' ";
