     ...
     if($rut == "" || $nombres == "" || $ape_mat == "" || $ape_pat =="" || $correo == "" || $fono == "" || $direccion == ""){ 
       ...
       //actualizar foto o no
        if($nombre == null || $nombre == ""){
            ...
            $query = "UPDATE usuarios_clientes SET nombres = '$nombres', a_paterno = '$ape_pat',a_materno = '$ape_mat', sexo = '$sexo', direccion = '$direccion', telefono = '$fono', correo = '$correo', nombre_archivo = '$nombre',comuna = '$comuna' WHERE rut = '$rut' ";
        }
