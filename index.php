...
<?php include("public/mensajes_alertas/login_incorrecto.php")?>
            ...
            <form action="list-tec.php" method="POST" >
                <div class="main_content pt-4">
                    <div class="titulo_index">
                        <h1 class="text-center font-italic pb-4 title--header">Contacta al técnico ideal !!</h1>
                    </div>
                    <div class="row justify-content-center "> 
                    
                        <div class="col-md-3 col-sm-6 mt-2">
                            <select class="form-control bg-white select--header" name="servicio" required>
                        ...
                        <div class="col-md-3 col-sm-6 mt-2">
                            ...
                            <select name="comuna" required="" id="address" class="address-input form-control select--header">
                        ...
                        <div class="col-md-3 col-sm-6 mt-2">
                            ...
                            <button class="btn btn-primary form-control btn--header" type="submit" name="buscar">
    ...
    <section class=" bg-light pb-5">
        <div class="container pb-5">
            <div class="pt-5 my-5">
                <h1 class="text-center my-5 text-secondary">Paso a paso clientes</h1>
            </div>
    ...
    <div class="item-diez ">
        <div class="row justify-content-center ">
            <div class="col-md-8">
                <h1 class="text-secondary text-center font-weight-light ">Ofrece tus servicios y se parte de Atudispo.cl</h1>
            </div>
            <div class="col-md-6 my-5">
                <div class="row justify-content-center">
                    <img src="public/img/ubicacion.svg" class="w-50" alt="">
    ...
    <section class=" bg-light pb-5 mt-5">
        <div class="container pb-5">
            <div class="pt-5 ">
                <h1 class="text-center my-5 text-secondary">Paso a paso Técnicos</h1>
            </div>
            <div class="row pasos mt-5 pt-4">
                <div class="col-md-6 col-sm-12 item-pasos paso-uno bg-white item-ptd " data-aos="fade-up">
                    <div class="row ">
                        <div class="col-5 pt-5 pl-4">
                            <img src="public/img/register.svg" class="w-75" alt="">
                        </div>
                        <div class="col-2 pt-5">
                            <h1>1</h1>
                        </div>
                        <div class="col-5 pt-5">
                            <h5 class="pt-4">Registrate con tus datos para ingresar a tu Backoffice.</h5>
                        </div>
                    </div>
                ...
                <div class="row ">
                        <div class="col-5 pt-4 pl-4">
                            <img src="public/img/forms_complete.svg" class="w-100" alt="">
                        </div>
                        <div class="col-2 pt-5">
                            <h1>2</h1>
                        </div>
                        <div class="col-5 pt-5">
                            <h5 class="pt-4">Completa tu portafolio para ser visualizado por los clientes.</h5>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12 item-pasos paso-uno bg-white item-ptd" data-aos="fade-up">
                    <div class="row ">
                        <div class="col-5 pt-4 pl-4">
                            <img src="public/img/contactar.svg" class="w-75" alt="">
                        </div>
                        <div class="col-2 pt-5">
                            <h1>3</h1>
                        </div>
                        <div class="col-5 pt-3">
                            <h5 class="pt-4">Ya estaras listo para ser contactado por los clientes.</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6 item-pasos">
                ...
                <div class="row ">
                        <div class="col-5 pt-5 pl-5">
                            <img src="public/img/evaluado.svg" class="w-100" alt="">
                        </div>
                        <div class="col-2 pt-5">
                            <h1>4</h1>
                        </div>
                        <div class="col-5 pt-5">
                            <h5 class="pt-4">Luego de tu trabajo, solicita la evaluación de tu cliente.</h5>
                        </div>
                    </div>
                </div>
            </div>
